...
function install_client() {
  ...
  *)
  ...
  wget https://revproxy.frknet.us.kg/https://raw.githubusercontent.com/cokemine/nodestatus-client-go/master/service/status-client.service -P /usr/lib/systemd/system/
